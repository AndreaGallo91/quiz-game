...
function ResultsScreen({ score, results, category, onRestart, onPlayAgain, onChangeCategory }) {
    ...
    <>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 animate-fade-in">
        ...
        <div className="w-full max-w-sm space-y-3">
          ...
          <button
            onClick={onRestart}
            className="btn-hover-scale w-full py-4 bg-gray-800/50 text-gray-300
              font-bold rounded-xl text-lg border border-gray-700
              hover:border-space-yellow hover:text-white"
          >
            🏠 Menu Principale
          </button>
        </div>
